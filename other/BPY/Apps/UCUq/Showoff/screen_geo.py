...
WIDTH_ = ucuq.ravel.SCREEN_WIDTH
HEIGHT_ = ucuq.ravel.SCREEN_HEIGHT
...
def animStarfield(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.03
...
def animTunnel(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.03
  t = 0.0
  ...
  for _ in runTimedLoop(duration, frameDelay):
    ...
    for y in range(height):
      for x in range(width):
        ...
        screen.pixel(x, y, 1 if v > 0 else 0)
    screen.show()
    t += 0.15


def animFire(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.03
...
def animMetaballs(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.03
    ...
    for y in range(height):
      for x in range(width):
        ...
        for bx, by, _, _ in balls:
          ...
          dy = y - by
          v += 1.0 / (dx*dx + dy*dy + 1)
        screen.pixel(x, y, 1 if v > 0.03 else 0)
    screen.show()


def animMatrixRain(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.05
...
def animLightning(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.05
...
def animWaves(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.03
  t = 0.0
...
def animSpiral(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.03
  t = 0.0
...
def animGravityParticles(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.03
  ...
  for _ in runTimedLoop(duration, frameDelay):
    ...
    for p in particles:
      ...
      if 0 <= int(px) < width and 0 <= int(py) < height:
        screen.pixel(int(px), int(py), 1)
    screen.show()


def animPlasmaFractal(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.03
  t = 0.0
...
def animConcentricWaves(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.03
  t = 0.0
...
def animNeuronal(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.03
...
def animOpticalDistortion(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.03
  t = 0.0
  ...
  for _ in runTimedLoop(duration, frameDelay):
    ...
    for y in range(height):
      for x in range(width):
        ...
        screen.pixel(x, y, 1 if v > 0.02 else 0)
    screen.show()
    t += 0.12


def animVectorField(screen, duration=2.0):
  width = WIDTH_
  height = HEIGHT_
  frameDelay = 0.05
  t = 0.0
