...
function displayExit(html) {
	...
	document.body.firstElementChild.insertAdjacentHTML('beforebegin','<span style="width: 100%; background-color: salmon;"><iframe style="border: none;" width="100%" height="0px" src="' + src + '"></iframe></span>');
	window.scroll(0,0);
}
