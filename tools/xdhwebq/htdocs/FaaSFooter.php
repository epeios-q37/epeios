  ...
  <script>
    function toggle() {
      ...
      if (qrCode.style.display === "none") {
        ...
        setTimeout(() => qrCode.scrollIntoView(
          {
            block: "end",
            behavior: "smooth"
          }), 200);
...
<body onload="prepare()">
  <div>
    ...
    if (file_exists($sponsors)) {
      include $sponsors;
    } else {
      // Gestion alternative si le fichier n'existe pas
