...
<body onload="prepare()">
  <div>
    <div style="justify-content: space-around; display: flex; align-items: center; padding: 5px 0px;">
      <span style="display: flex;">
        <img onclick="toggle();" style="cursor: pointer" title="Displays the QR code to access the application" src="data:image/png;base64,"/>
      ...
      <a href="https://zelbinium.org" target="_blank">
